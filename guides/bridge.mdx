---
title: "Interact with HungerBridge Using BridgeClient"
sidebarTitle: "HungerBridge"
description: "BridgeClient is HungerLib's Python client for the HungerBridge v2 REST API, enabling command execution, logging, TPS monitoring, and player queries on Minecraft servers."
---
