---
title: "Connect to a Pterodactyl Panel with Panel"
sidebarTitle: "Panel"
description: "The Panel class is HungerLib's authenticated HTTP client for the Pterodactyl Client API — covering health checks, files, schedules, databases, backups, and startup variables."
---
...
<CardGroup cols={2}>
  ...
  <Card title=".databases" icon="server">
