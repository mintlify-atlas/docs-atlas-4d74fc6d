...
description: "Reference for FileManagerAPI (panel.files): list, download, upload, delete, rename, copy, move, create folders, compress, and decompress server files via the Pterodactyl Client API."
---
...
**Endpoint:** `GET /api/client/servers/{server_id}/files/list`
...
**Endpoint:** `GET /api/client/servers/{server_id}/files/download`
