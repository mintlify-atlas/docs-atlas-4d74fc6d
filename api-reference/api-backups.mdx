...
description: "Reference for BackupsAPI (panel.backups): list, create, delete, and download server backups via the Pterodactyl Client API. Returns requests.Response."
---
