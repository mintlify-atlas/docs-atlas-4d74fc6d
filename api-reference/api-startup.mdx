...
description: "Reference for StartupAPI (panel.startup): list and update server startup variables via the Pterodactyl Client API. All methods return requests.Response."
---
